...
import { createRandomOperation, createRandomProduct, generateRandomNumber, getRandomString } from './3_write';

describe('all', () => {
  it('generateRandomNumber', () => {
    let randomNumber = generateRandomNumber(3, 15);
    console.log(randomNumber);
    expect(randomNumber >= 3 && randomNumber <= 15).toEqual(true);
  });

  it('randomString', () => {
    let randomString = getRandomString();
    console.log(randomString);
    expect(randomString.length >= 3 && randomString.length <= 15).toEqual(true);
  });
  it('operation', () => {
